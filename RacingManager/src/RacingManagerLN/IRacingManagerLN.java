...
public interface IRacingManagerLN {
    ...
    void adicionarC1Hibrido(String aIdCarro, String aMarca, String aModelo, int aPotenciaCombustao,int aPotenciaEletrica ,float aPac, float downforce, int acilndrada, String tipoPneu, String modoMotor);
    ...
    void adicionarC2Hibrido(String aIdCarro, String aMarca, String aModelo, int aPotenciaCombustao,int aPotenciaEletrica ,float aPac, String tipoPneu, int aCilindrada, String modoMotor, float downforce);
    ...
    void adicionarGTHibrido(String aIdCarro, String aMarca, String aModelo, int aPotenciaCombustao,int aPotenciaEletrica ,float aPac, int aCilindrada, String tipoPneu, float downforce, String modoMotor);
